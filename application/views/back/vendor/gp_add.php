<div>
  <?php
        echo form_open(base_url() . 'index.php/vendor/gp_product/do_add', array(
...
function gp_pradd()
{
  ...
  var gp_descr  = $("#gpshort_descr").val();
    ...
    $.post("<?php echo base_url(); ?>index.php/vendor/gp_product/do_add",
    {
...
function gp_product(gpid,gname,gquant,gpl,gpw,gph,gpweight)
{
    ...
    var pname=gname;
    var quantity=gquant;
    tbli= document.getElementById('group-list-gp');
...
{    
    ...
    if(quantity>0 && ain==1)
    {
    tbl = document.getElementById('group-list-gp');
    ...
    jQuery('table#group-list-gp').append(newRow);
    $(".ccmm").click();
