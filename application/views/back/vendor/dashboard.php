...
<style> .widgetfront .panel{ min-height: auto; } .panel-title{ text-align: center; }</style>
        ...
        <div class="row">
            <div class="col-md-12 col-lg-12 nopad">
                <div class="col-md-4 col-lg-4 widgetfront userwidget">
                    <div class="panel panel-bordered panel-grad2">
                        <div class="panel-heading">
                            <h3 class="panel-title"><?php echo translate("today's_sale");?></h3>
                        </div>
                        <div class="panel-body">
                            <div class="text-center">
                                <h3><?php echo $vendor->currency. ' ' . number_format((float) $todaySale, 2, '.', '');?></h3>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-lg-4 widgetfront userwidget">
                    <div class="panel panel-bordered panel-grad2">
                        <div class="panel-heading">
                            <h3 class="panel-title"><?php echo translate("this_month_sale");?></h3>
                        </div>
                        <div class="panel-body">
                            <div class="text-center">
                                <h3><?php echo $vendor->currency. ' ' . number_format((float) $currMthSale, 2, '.', '');?></h3>
                            </div>
                        </div>
                    </div>
                </div>
