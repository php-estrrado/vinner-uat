<div class="row">
    ...
    <div class="col-md-12">
        <?php
            echo form_open(base_url() . 'index.php/vendor/product_group/do_add/', array(
...
<!--Panel body-->
        <div class="panel-body">
         ...
         <!-- <button class="btn btn-primary btn-labeled fa fa-plus-circle " 
                  onclick="ajax_modal('gp_edit','<?php //echo translate('edit_product'); ?>','<?php //echo translate('successfully_added!');?>','gp_edit','8708')">
                <?php //echo translate('edit_Products');?>
              </button>  -->
            </div>
...
<script type="text/javascript">
    ...
    {
        ajax_load(base_url+'index.php/vendor/product/sale_by_pro/'+id,'reserve','other');
        ajax_load(base_url+'index.php/vendor/product/name_by_pro/'+id,'pname','other');
    }
