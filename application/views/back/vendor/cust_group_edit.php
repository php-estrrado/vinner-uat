...
<div>
    <?php
        echo form_open(base_url() . 'index.php/vendor/customer_group/update/'. $row['group_id'], array(
                ...
                <div class="col-sm-6">
                    <?php 
                          ...
                          //echo $row3;
                                ...
                                // echo $by;''
                               //$row3=["3","19"];
                              //$row3=["151","184","193","195","198"];
                             // echo $this->crud_model->select_html('user','user','username','edit','demo-cs-multiselect',$row3);

                         //echo $this->crud_model->select_html('product','product','title','edit','demo-cs-multiselect');
                          echo $this->crud_model->select_html('user','user','username','edit','demo-cs-multiselect',$row3);
