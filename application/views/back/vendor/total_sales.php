                    ...
                    <div class="tab-pane fade active in" id="list" style="border:1px solid #ebebeb; border-radius:4px;">
						...
						<div class="fixed-table-toolbar" align="center">
							<div class="">
								...
								<a  class=" btn btn-info btn-labeled fa fa-arrow-left" type="button" href="<?php echo base_url()."vendor/report_sale/"; ?>" > 
									Back 
								</a>
							</div> 
						</div>
...
<div id='export-div'>
        ...
        <table id="export-table" data-name='Total Sales Invoice' data-orientation='p' data-width='1800' style="display:none;">
        <col width="50">
        <col width="200">
        <col width="200">
        <col width="250">
        ...
        ?>
        <!-- <tr><th colspan="5" width="800" align="center"><b>Total Sales Amount</b></th><th width="200"> <b><?php echo currency().$this->cart->format_number($gdtotal);  ?> </b></th></tr> -->
