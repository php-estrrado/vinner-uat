<script>
	...
	var pplds = "<?php echo translate("payfort_payment_disabled!"); ?>";
	var pplen = "<?php echo translate("payfort_payment_enabled!"); ?>";
	...
	var enb_ven = "<?php echo translate("status_updated_successfully!"); ?> ";
