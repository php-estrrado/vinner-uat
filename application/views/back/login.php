...
<body>
	<div id="container" class="cls-container">
		...
		<div class="cls-content">
			<div class="cls-content-sm panel panel-colorful panel-login" style="margin-top: 80px !important;">
				<div class="brandlogo">
				...
				<div class="panel-body adminpopup">				
					<p class="signtext"><?php echo translate('sign_in_to_your_account');?></p>
					<?php
					...
					?>
						...
						<div class="row">
							<div class="col-xs-6 text-left">
                            	<div class="pad-ver">
									<a  href="#" onclick="ajax_modal('forget_form','<?php echo translate('forget_password'); ?>','<?php echo translate('email_sent_with_new_password!'); ?>','forget','')" class="btn-link mar-rgt" style="color:#9f9f9f !important;">
							...
							<div class="col-xs-6">
								<div class="form-group text-right">
									<span id="btn_login" class="btn btn-login fa fa-unlock-alt snbtn" onclick="form_submit('login')">
