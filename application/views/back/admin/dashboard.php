            ...
            <div class="col-md-12 col-lg-12">
            	...
            	<div class="col-md-8 col-lg-8">
                    <div class="panel panel-bordered panel-grad">
                        <div class="panel-heading">
                            <h3 class="panel-title"><?php echo translate('warehouse_statistics');?></h3>
                        </div>
                        <div class="panel-body">
                            <div class="text-center">
                                <div class="col-md-12 col-lg-12">
                ...
                <div class="col-md-4 col-lg-4">
                    <div class="panel panel-bordered panel-dark" style="height:128px;">
                        <div class="panel-heading">
                            <h3 class="panel-title"><?php echo translate('total_warehouse');?></h3>
                        </div>
                        <div class="panel-body">
                            <div class="text-center">
                                <h1>
                    ...
                    <div class="panel-heading">
                       <h3 class="panel-title"><?php echo translate('total_customers');?></h3>
                        ...
                        <div class="panel-body">
                            <div class="text-center">
                                <h1>
                                    <?php echo $this->db->get_where('user',array('status = '=>'approved'))->num_rows();?>
                                </h1>
                            </div>
                        </div>
                    </div>
...
<!--    <div class="panel-body" id="demo_s">
  <div class="panel-heading">
        ...
        <tr class="<?php if($row1['viewed'] !== 'ok'){ echo 'pending'; } ?>" >
            ...
            <td><?php
             ...
             <td>
                ...
                <?php
                        if(isset($dev['vendor'])){
                            echo $this->crud_model->get_type_name_by_id('vendor', $dev['vendor'], 'display_name').' ('.translate('warehouse').') : '.$dev['status'].'<br>';
                        } else if(isset($dev['admin'])) {
                            echo translate('admin').' : '.translate($dev['status']);
                        }
                ?>
                </div>
                <?php
            ...
            <td class="text-right">
               ...
               <a class="btn btn-info btn-xs btn-labeled fa fa-file-text" data-toggle="tooltip" 
                    onclick="ajax_admin_vieworder('order_home','<?php echo translate('title'); ?>','<?php echo translate('successfully_edited!'); ?>','sales_view','<?php echo $row1['sale_id']; ?>')" 
   ...
   <?php      include_once 'low_stock.php'; ?> 
