...
<div id='export-div'>
        <h1 style="display:none;"><?php echo translate('Blog_list_Report'); ?></h1>
        <table id="export-table" data-name='Blog List Report' data-orientation='p' style="display:none;">
        <col width="50">
        <col width="500">
        <col width="200">
                <thead>
                    <tr>
                        ...
                        <th style="width:4ex"><?php echo translate('title');?></th>
                        <th style="width:6ex"><?php echo translate('date');?></th>
                    </tr>
                </thead>
