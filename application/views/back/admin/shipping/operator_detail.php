<div><?php
    ...
    $status         =   ($operator)? $operator->status : 1;
...
<!--            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" name="phone" id="demo-hor-1" placeholder="<?php echo translate('phone'); ?>" class="form-control numberonly required" value="<?php echo $phone?>">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                   <input type="url" name="website" id="website" placeholder="<?php echo translate('website'); ?>" class="form-control required" value="<?php echo $website?>">
                   <span id='error_website' class="error_msg"></span>
                </div>
            </div>
            <div class="form-group">
