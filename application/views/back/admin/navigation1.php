                    ...
                    <ul id="mainnav-menu" class="list-group">
                        ...
                        <li <?php if($page_name=="mostviewed" || 
                            ...
                            <ul class="collapse <?php if($page_name=="mostviewed" || 
                                ...
                                <li <?php if($page_name=="mostviewed"){?> class="active-link" <?php } ?> >
                                    <a href="<?php echo base_url(); ?>index.php/admin/most_viewed/">
                                    	<i class="fa fa-circle fs_i"></i>
                        ...
                        <!--Menu list item-->
                         <li <?php if($page_name=="reviews" || 
                            ...
                            <!--REPORT-------------------->
                            <ul class="collapse <?php if($page_name=="reviews" || 
                                                            $page_name=="review_approval" ||
                                                                $page_name=="review_view" ){?>
                                                                             in
                                                                                <?php } ?> ">
                                <li <?php if($page_name=="reviews"){?> class="active-link" <?php } ?> >
                                    <a href="<?php echo base_url(); ?>index.php/admin/reviews/">
                                        <i class="fa fa-circle fs_i"></i>
