    ...
    <table id="demo-table" class="table table-striped"  data-pagination="true" data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" >
        ...
        <tr>
            ...
            <td class="text-right">
                ...
                <?php }  else {  ?>
                <a class="btn btn-info btn-xs btn-labeled fa fa-check" data-toggle="tooltip" 
                    onclick="ajax_modal('view','<?php echo translate('view_payment_details'); ?>','<?php echo translate('successfully_saved!'); ?>','membership_payment_view','<?php echo $row['membership_payment_id']; ?>')" data-original-title="View" data-container="body">
                        <?php 
