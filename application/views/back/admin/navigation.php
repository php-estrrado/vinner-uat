                    ...
                    <ul id="mainnav-menu" class="list-group">
                                ...
                                ?>
                                    <li <?php if($page_name=="vendor_product"){?> class="active-link" <?php } ?> >
                                        <a href="<?php echo base_url(); ?>admin/vendor_product">
                                            <i class="fa fa-circle fs_i"></i>
                                                <?php echo translate('warehouse_products');?>
                                        </a>
                                    </li>
                                    <li <?php if($page_name=="product/certificates"){?> class="active-link" <?php } ?> >
                                        <a href="<?php echo base_url(); ?>admin/certificates">
                                            <i class="fa fa-circle fs_i"></i>
                                                <?php echo translate('certificates');?>
                                        </a>
                                    </li>
                                    <?php
                                    } /*if($this->crud_model->admin_permission('product')){
                       ...
                       <?php
                        ...
                        <?php
                            ...
                            <li <?php if($page_name=="abandon_group"){?> class="active-link active-sub" <?php } ?> >
                                <a href="<?php echo base_url(); ?>admin/abandon_group/">
                                    <i class="fa fa-tags"></i>
                                        <span class="menu-title">
                                            <?php echo translate('abandon_groups');?>
                                        </span>
                                </a>
                            </li>
                        ...
                        ?>
                        <!--Menu list item-->
                        <li <?php if($page_name=="vendor" || $page_name=="membership_payment" || $page_name=="membership" || $class=='warehouse' ){?>
                                                     class="active-sub" <?php } ?>>
                            <a href="#">
                                <i class="fa fa-user-plus"></i>
                                    <span class="menu-title">
                                        <?php echo translate('warehouses');?>
                                    </span>
                                        <i class="fa arrow"></i>
                            </a>
                            
                            <ul class="collapse <?php if($page_name=="vendor" || $page_name=="membership_payment" || 
														 $page_name=="membership" || $class=='warehouse' ){?>  in  <?php } ?> ">
                                <li <?php if($page_name=="vendor"){?> class="active-link" <?php } ?> >
                                    <a href="<?php echo base_url(); ?>admin/warehouse/">
                                        <i class="fa fa-circle fs_i"></i>
                                            <?php echo translate('warehouse_list');?>
                                    </a>
                                </li>
                                <li <?php if($class=="warehouse" && $method=='priceChange' ){?> class="active-link" <?php } ?> >
                                    <a href="<?php echo base_url(); ?>admins/warehouse/priceChange/">
                                        <i class="fa fa-circle fs_i"></i>
...
<!--                        <li <?php if($page_name=="activation" || 
 ...
 <!--marketing tools-->
                        ...
                        <li style="display:none;" <?php if($page_name=="newsletter" || 
...
<!--tax addition-->
             ...
             <li style="display:none;" <?php if($page_name=="tax" || $page_name=="stax") {?> class="active-sub" <?php } ?> >
                    <a href="#">
                        <i class="fa fa-money"></i>
                            <span class="menu-title">
