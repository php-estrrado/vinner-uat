    ...
    <div class="tab-base">
        ...
        <div class="panel">
             ...
             <div class="col-md-12" style="border-bottom: 1px solid #ebebeb;padding: 5px;">
               <a href="<?php echo base_url().'index.php/admin/product'; ?>"> <button class="btn btn-info btn-labeled fa fa-step-backward pull-right ">
...
?>
 <?php
        echo form_open(base_url() . 'index.php/admin/import_product/', array(
...
<b><a style="color:blue;" href="<?php echo base_url().'uploads/product_brochure/product_csv.csv'?>">Sample CSV</a> <b/>
  ...
  <ul class="list-group">
    ...
    <div id="collapse5" class="panel-collapse collapse">
     ...
     <table id="demo-table" class="table table-striped" >
     <thead><tr><th>Brand Name</th><th align="center">Code</th></tr></thead></table>
      <table id="demo-table" class="table table-striped" >
...
<!-- Length,Width,Height,Length_class,Weight,Weight_class-->     
    <li class="list-group-item"><b>Length</b>:Product Length in cm | <b>Width</b>:Product Width in cm | <b>Height</b>: Product Height in cm |<b>Weight</b>:Product Weight in kg| Description |HS_code |Short Description </li>
