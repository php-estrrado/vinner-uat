                ...
                <div class="row">
                    ...
                    <div class="col-md-11">
                     ...
                     <div class="col-md-1">
                     	...
                     	<span class="btn btn-success btn-md btn-labeled fa fa-wrench pull-right" onclick="form_submit('blog_edit','<?php echo translate('successfully_edited!'); ?>');proceed('to_add');" ><?php echo translate('Update');?></span> 
