            ...
            <div class="table-responsive">
                <table class="table table-striped">
                    <tr>
                        ...
                        <td>
							<?php 
								$total_sold = $this->crud_model->vendor_share_total($vendor_id); 
								echo '$ '.$total_sold['total']; 
							?>
						</td>
                    </tr>
                    <tr>
                        ...
                        <td>
							<?php 
								$total_payable = $this->crud_model->vendor_share_total($vendor_id,'paid'); 
								echo '$ '.$total_payable['total']; 
							?>
						</td>
                    </tr>
					<?php /*
