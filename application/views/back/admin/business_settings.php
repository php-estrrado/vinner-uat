    ...
    <div class="tab-base">
        <div class="tab-base tab-stacked-left">
            ...
            /*payfort integration*/
               ...
               $payfort_set= $this->db->get_where('business_settings', array(
                    'type' => 'payfort_set'
                ))->row()->value;
             $payfort_accesscode    = $this->db->get_where('business_settings', array(
                    'type' => 'payfort_accesscode'
                ))->row()->value;
             
               $payfort_sha_type= $this->db->get_where('business_settings', array(
                    'type' => 'payfort_sha_type'
                ))->row()->value; 
               $payfort_sha_request= $this->db->get_where('business_settings', array(
                    'type' => 'payfort_sha_request'
                ))->row()->value; 
            $payfort_sha_response= $this->db->get_where('business_settings', array(
                    'type' => 'payfort_sha_response'
                ))->row()->value;
            /*/payfort integration*/
                ...
                $shipment_method = $this->db->get_where('business_settings', array(
                    'type' => 'shipment_method'
                ))->row()->value;             
            ...
            <div class="panel panel-bordered-dark">
             ...
             <!--Stripe to paypal account setting-->           
...
/*                                    $from = array('sandbox','original');
                  ...
                  -->   
                             ...
                             <!--/stripe to paypal no need-->   
                             
                             
                             
                             
                             <!--PAY FORT INTEGRATION-->
                             <div class="form-group">
                            <label class="col-sm-3 control-label" for="demo-hor-inputemail"><?php echo translate('payfort_payment');?></label>
                            <div class="col-sm-6">
                                <div class="col-sm-">
                                    <input id="payfort_set" class='sw8' data-set='payfort_set' type="checkbox" <?php if($payfort_set == 'ok'){ ?>checked<?php } ?> />
                                </div>
                            </div>
                        </div>

                        <div class="form-group">
                            <label class="col-sm-3 control-label"><?php echo translate('payfort_access_code');?></label>
                            <div class="col-sm-6">
                                <input type="text" name="payfort_accesscode" value="<?php echo $payfort_accesscode; ?>" class="form-control">
                            </div>
                        </div>

                        <div class="form-group">
                            <label class="col-sm-3 control-label"><?php echo translate('payfort_sha_type');?></label>
                            <div class="col-sm-6">
                                <input type="text" name="payfort_sha_type" value="<?php echo $payfort_sha_type; ?>" class="form-control">
                            </div>
                        </div>
                            
                            
                            <div class="form-group">
                            <label class="col-sm-3 control-label"><?php echo translate('payfort_sha_request');?></label>
                            <div class="col-sm-6">
                                <input type="text" name="payfort_sha_request" value="<?php echo $payfort_sha_request; ?>" class="form-control">
                            </div>
                        </div>
                            <div class="form-group">
                            <label class="col-sm-3 control-label"><?php echo translate('payfort_sha_response');?></label>
                            <div class="col-sm-6">
                                <input type="text" name="payfort_sha_response" value="<?php echo $payfort_sha_response; ?>" class="form-control">
                            </div>
                        </div>
                             <!--//PAY FORT INTEGRATION-->
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label"><?php echo translate('Own freight agent');?></label>
                            <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label"><?php echo translate('Local freight agent');?></label>
                            <div class="col-sm-6">
                                <textarea class="summernotes" data-height="200" data-name="shipment_method" ><?php echo $shipment_method; ?></textarea>
                            </div>
                        </div>
                       <!-- <div class="form-group">
