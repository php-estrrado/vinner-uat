        ...
        <table id="demo-table" class="table table-striped"  data-pagination="true" data-show-refresh="true" data-ignorecol="0,2" data-show-toggle="true" data-show-columns="false" data-search="true" >
            ...
            <thead>
                <tr>
                   ...
                   <!-- <th><?php //echo translate('Name_of_Organization');?></th>-->
            ...
            <tr>
                ...
                <td><?php //echo $row['product_id']; ?> <?php echo $this->crud_model->get_type_name_by_id('product',$row['product_id'],'title'); ?></td>
                ...
                <td class="text-right">
                    ...
                    <a onclick="delete_confirm('<?php echo $row['quote_message_id']; ?>','<?php echo translate('really_want_to_delete_this?'); ?>')" class="btn btn-danger btn-xs btn-labeled fa fa-trash" data-toggle="tooltip" 
    ...
    <div id='export-div'>
        ...
        <table id="export-table" data-name='quote_messages' data-orientation='l' style="display:none;">
                <thead>
                    <tr>
                        <th><?php echo translate('no');?></th>
                        <th><?php echo translate('name');?></th>
