<?php
	...
	foreach($service_req_data as $row){
...
?>
    ...
    <div>
        ...
        <?php
			...
			echo form_open(base_url() . 'index.php/admin/request_service/update/' . $row['request_id'], array(

				'class' => 'form-horizontal',

				'method' => 'post',

				'id' => 'request_service_edit',
		...
		?>
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        ...
                        <input type="text" name="address" id="demo-hor-1" value="<?php echo $row['address']; ?>" 

                            placeholder="<?php echo translate('address'); ?>" class="form-control required">
            ...
            <!--    <div class="col-sm-6"> -->
                    ...
                    <?php// echo $this->crud_model->select_html_data('cities','city','name','edit','demo-chosen-select required',$row['city']); ?>
            ...
            <div class="form-group">
                ...
                <label class="col-sm-4 control-label"><?php echo translate('service_category');?></label>

                <div class="col-sm-6"> 

                    <?php echo $this->crud_model->select_html('service_category','service_category','name','edit','demo-chosen-select required',$row['service_category'],'status',1); ?>
            ...
            <div class="form-group">
                ...
                <label class="col-sm-4 control-label"><?php echo translate('service_type');?></label>

                <div class="col-sm-6"> 

                    <?php echo $this->crud_model->select_html('service_type','service_type','type','edit','demo-chosen-select required',$row['service_type'],'status',1); ?>
            ...
            <div class="form-group">
                <label class="col-sm-4 control-label" for=""><?php echo translate('type');?></label>
                <div class="col-sm-6">
                    <input type="text" name="type_detail"  id="drc_type" value="<?php echo $row['type_detail']; ?>" class="form-control">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <textarea id="" name="remarks" class="form-control required" rows="4" cols="40"><?php echo $row['remark']; ?></textarea>
