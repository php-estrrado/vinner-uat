<div class="panel-body" id="demo_s">
    <table id="demo-table" class="table table-striped"  data-pagination="true" data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" >
        ...
        <tr>
            ...
            <td>
                <img class="img-sm img-circle img-border"
                    <?php 
                        ...
                        src="<?php echo base_url(); ?>uploads/user_image/user_<?php echo $row['user_id']; ?>.jpg?<?php echo time(); ?>"<?php } else if($row['fb_id']){ ?>
            ...
            <td class="text-right"><?php echo currency().$this->crud_model->total_purchase($row['user_id']); ?></td>
            <td class="text-right">
