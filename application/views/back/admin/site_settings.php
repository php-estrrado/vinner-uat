...
<!--
                    ...
                    <li >
                     ...
                     <li >
                        ...
                        <a data-toggle="tab" href="#demo-stk-lft-tab-cup"><?php echo translate('coupon_setting');?></a>
                   ...
                   <!--  <li>
                    ...
                    <!--
                    <li>
                        <a data-toggle="tab" href="#demo-stk-lft-tab-rp"><?php echo translate('return_policy');?></a>
                    </li> -->
                    <!--
                    <li>
                        <a data-toggle="tab" href="#demo-stk-lft-tab-wt"><?php echo translate('warranty_terms');?></a>
                    </li> -->
					<li>
                        <a data-toggle="tab" href="#demo-stk-lft-tab-sh"><?php echo translate('shipping_&_handling');?></a>
                    </li>
                    <li>
                        <a data-toggle="tab" href="#demo-stk-lft-tab-rc"><?php echo translate('refund_&_cancellation_policy');?></a>
                    </li>
                    <li>
                        <a data-toggle="tab" href="#demo-stk-lft-tab-cr"><?php echo translate('cancellation_&_replacement_policy');?></a>
                    </li>
                    <li>
                        <a data-toggle="tab" href="#demo-stk-lft-tab-faq"><?php echo translate('FAQs');?></a>
                    </li>
...
<!-- Coupon Setting -->
                    ...
                    <div id="demo-stk-lft-tab-cup" class="tab-pane fade">
                         ...
                         <div class="col-md-12">
                            ...
                            <div class="panel">
                                ...
                                <div class="panel-heading">
                                    ...
                                    <h3 class="panel-title"><?php echo translate('coupon_field');?></h3>

                                </div>

                            <?php
                            echo form_open(base_url() . 'index.php/admin/coupon_settings/', array(
                                    'class' => 'form-horizontal',
                                    'method' => 'post',
                                    'id' => '',
                                    'enctype' => 'multipart/form-data'
        ...
        <label class="col-sm-4 control-label" style="text-align: right;"><?php echo translate('Coupon_Field');?></label>
...
<div class="btn-group col-sm-6" data-toggle="buttons">
  <label class="btn btn-info <?php if($cput==1){ ?> active  <?php } ?> ">
    <input type="radio" name="coupon_set" id="option2" autocomplete="off" value="1"> Show
  </label>
  <label class="btn btn-danger <?php if($cput==0){ ?> active  <?php } ?> ">
    <input type="radio" name="coupon_set" id="option3" autocomplete="off" value="0"> Hide
  </label>
</div>
                                    </div>
                                </div>
...
<!-- Cupon Setting -->
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group mar-btm">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="input-group mar-btm" style="margin-top: 15px;">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="input-group mar-btm">
                                                ...
                                                <span class="input-group-addon l_font">
                ...
                ?>
                    ...
                    <div id="demo-stk-lft-tab-rp" class="tab-pane fade">

                        <div class="panel">

                            <?php 

                                $return_policy =  $this->db->get_where('general_settings',array('type' => 'return_policy'))->row()->value;

                            ?>

                            <div class="panel-heading">

                                <h3 class="panel-title"><?php echo translate('return_policy');?></h3>

                            </div>

                            <?php

                                echo form_open(base_url() . 'index.php/admin/general_settings/return_policy/', array(
                            ...
                            ?>
                                ...
                                <div class="panel-body">
                                    ...
                                    <textarea class="summernotes" data-height='700' data-name='return_policy' ><?php echo $return_policy; ?></textarea>
                    ...
                    <div id="demo-stk-lft-tab-wt" class="tab-pane fade">
                        <div class="panel">
                            <?php 
                                $warranty_terms =  $this->db->get_where('general_settings',array('type' => 'warranty_terms'))->row()->value;
                            ?>

                            <div class="panel-heading">
                                <h3 class="panel-title"><?php echo translate('warranty_terms');?></h3>
                            </div>

                            <?php
                                echo form_open(base_url() . 'index.php/admin/general_settings/warranty_terms/', array(
                                    'class' => 'form-horizontal',
                                    'method' => 'post',
                                    'id' => '',
                                    'enctype' => 'multipart/form-data'
                            ...
                            ?>
                                ...
                                <div class="panel-body">
                                    <textarea class="summernotes" data-height='700' data-name='warranty_terms' ><?php echo $warranty_terms; ?></textarea>
                                </div>
					...
					<div id="demo-stk-lft-tab-sh" class="tab-pane fade">
                        <div class="panel">
                            <?php 
                                $shipping_handling=  $this->db->get_where('general_settings',array('type' => 'shipping_handling'))->row()->value;
                            ?>

                            <div class="panel-heading">
                                <h3 class="panel-title"><?php echo translate('shipping_handling');?></h3>
                            </div>

                            <?php
                                echo form_open(base_url() . 'index.php/admin/general_settings/shipping_handling/', array(
                                    'class' => 'form-horizontal',
                                    'method' => 'post',
                                    'id' => '',
                                    'enctype' => 'multipart/form-data'
                            ...
                            ?>
                                ...
                                <div class="panel-body">
                                    <textarea class="summernotes" data-height='700' data-name='shipping_handling' ><?php echo $shipping_handling; ?></textarea>
                                </div>
                    ...
                    <div id="demo-stk-lft-tab-rc" class="tab-pane fade">
                        <div class="panel">
                            <?php 
                                $refund_cancellation_policy=  $this->db->get_where('general_settings',array('type' => 'refund_cancellation_policy'))->row()->value;
                            ?>

                            <div class="panel-heading">
                                <h3 class="panel-title"><?php echo translate('refund_&_cancellation_policy');?></h3>
                            </div>

                            <?php
                                echo form_open(base_url() . 'index.php/admin/general_settings/refund_cancellation_policy/', array(
                                    'class' => 'form-horizontal',
                                    'method' => 'post',
                                    'id' => '',
                                    'enctype' => 'multipart/form-data'
                            ...
                            ?>
                                ...
                                <div class="panel-body">
                                    <textarea class="summernotes" data-height='700' data-name='refund_cancellation_policy' ><?php echo $refund_cancellation_policy; ?></textarea>
                                </div>
                    ...
                    <div id="demo-stk-lft-tab-cr" class="tab-pane fade">
                        <div class="panel">
                            <?php 
                                $cancellation_replacement_policy=  $this->db->get_where('general_settings',array('type' => 'cancellation_replacement_policy'))->row()->value;
                            ?>

                            <div class="panel-heading">
                                <h3 class="panel-title"><?php echo translate('cancellation_&_replacement_policy');?></h3>
                            </div>

                            <?php
                                echo form_open(base_url() . 'index.php/admin/general_settings/cancellation_replacement_policy/', array(
                                    'class' => 'form-horizontal',
                                    'method' => 'post',
                                    'id' => '',
                                    'enctype' => 'multipart/form-data'
                            ...
                            ?>
                                ...
                                <div class="panel-body">
                                    <textarea class="summernotes" data-height='700' data-name='cancellation_replacement_policy' ><?php echo $cancellation_replacement_policy; ?></textarea>
                                </div>
                    ...
                    <div id="demo-stk-lft-tab-faq" class="tab-pane fade">
                        <div class="panel">
                            <?php 
                                $frequently_asked_questions=  $this->db->get_where('general_settings',array('type' => 'frequently_asked_questions'))->row()->value;
                            ?>

                            <div class="panel-heading">
                                <h3 class="panel-title"><?php echo translate('frequently_asked_questions');?></h3>
                            </div>

                            <?php
                                echo form_open(base_url() . 'index.php/admin/general_settings/frequently_asked_questions/', array(
                                    'class' => 'form-horizontal',
                                    'method' => 'post',
                                    'id' => '',
                                    'enctype' => 'multipart/form-data'
                            ...
                            ?>
                                ...
                                <div class="panel-body">
                                    <textarea class="summernotes" data-height='700' data-name='frequently_asked_questions' ><?php echo $frequently_asked_questions; ?></textarea>
                                </div>
