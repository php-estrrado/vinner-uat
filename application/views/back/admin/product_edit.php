...
?>
<style> .delete-div-wrap img{ width: 100%; max-width: 80px, max-height: 80px; }</style>
		...
		new AjaxUpload(btnUpload, {
			...
			onSubmit: function(file, ext){
				 if (! (ext && /^(jpg|png|jpeg)$/.test(ext))){ 
					...
					$('#multi_img_error').text('Only JPG, PNG or GIF files are allowed'); $('#multi_img_error').show();
					return false;
				}
                                $('#multi_img_error').text(''); $('#multi_img_error').hide();
			...
			onComplete: function(file, response){
				...
				if(resp[0]==="success"){ 
                                    ...
                                    var imgContent  =   '<span class="close">&times;</span><div class="inner-div"><img class="img-responsive" style="max-width: 80px, max-height: 80px" src="<?php echo base_url('uploads/product_image/')?>product_'+prdId+'_'+resp[1]+'_thumb.jpg" data-id="'+prdId+'_'+resp[1]+'" alt="Product_Image" ></div>'
                    ...
                    <div class="tab-content">
                        <div id="product_details" class="tab-pane fade active in">
                            ...
                            <div class="form-group btm_border">
                              ...
                              <div class="col-sm-6">
                                <input value='1' class="sw89" type="checkbox" name="request_demo" <?php if($row['request_demo'] == 1){ echo 'checked="checked"'; } ?> data-id="<?php echo $row['product_id']; ?>"  />
                              </div>
                          </div>  
                            ...
                            <div class="form-group btm_border" id="brn" >
                                <label class="col-sm-4 control-label" for="demo-hor-4"><?php echo translate('industries');?></label>
                                <div class="col-sm-6" id="brand" >
                                    <?php echo $this->crud_model->select_html('brand','brand','name','edit','demo-cs-multiselect',json_encode(explode(',',$row['brand'])),'','','','Choose Industries'); ?>
                                </div>
                            </div>
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <em>( Image size : 400 X 400 )</em>
                                        <input type="file" name="primary_image" onchange="image_preview(this,'primage-previewImg');" id="demo-hor-primage" class="form-control ">
                                    </span>
                                    <br><br>
                                    <span id="primage-previewImg">
                                        <div style='float:left;border:4px solid #303641;padding:5px;margin:5px;'><img height='80' src='<?php echo $images[0];?>'></div>
                                    </span>
                                </div>                                              
                            </div>
                            ...
                            <div class="form-group btm_border">
                                ...
                                <div id="upload-imgsb" class="col-sm-8">
                                    <span class="pull-left btn btn-default btn-file"> 
                                        <div id="upload_img" ><?php echo translate('choose_images');?>
                                            <em>( Image size : 400 X 400 )</em>
                                        </div>
                                    </span> <div class="clr"></div>
                                    <span id="status" ></span>
                                    <span id="multi_img_error" class="label label-danger require_alert" style="display: none;"></span>
                                    <br/><br/>
                                    <div id="prd-imgs">
                                        <?php 
                                            //$images = $this->crud_model->file_view('product',$row['product_id'],'','','thumb','src','multi','all');
                                            ...
                                            {   
                                                ...
                                                foreach ($images as $row1)
                                                {
                                                    ...
                                                    <div class="delete-div-wrap ">
                                                        ...
                                                        <div class="inner-div">
                                                            <img class="img-responsive" style="width: 100%; max-width: 80px; max-height: 80px;"  src="<?php echo $row1; ?>" data-id="<?php echo $i.'_'.$p; ?>" alt="User_Image" >
                                                        </div>
                                                    </div>
                                                    <?php 
                                                }
...
<?php //} ?>  
                            ...
                            <div class="form-group btm_border" style="">
                                ...
                                <div class="col-sm-6">
                                  <textarea rows="5" class="form-control" id='shipping_info' name="shipping_info" data-height="100" data-name="shipping_info" placeholder="Shipping Info"><?php echo $row['shipping_info']; ?></textarea>
                                </div>
                            </div>
