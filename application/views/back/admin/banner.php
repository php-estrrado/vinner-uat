...
<br/>
<?php
$a = array('before_slider' );
foreach ($a as $r) {
$home = $this->db->get_where('banner', array('page' => 'home','place' => $r ))->result_array();
if (count($home) < 2) { $m = 3;
$l = 12;
} else {
$m = 12;
...
<div class="col-sm-12">
<img class="img-responsive img_show img-banner" src="<?php echo $this->crud_model->file_view('banner',$row['banner_id'],'','','thumb','src') ?>"  />
</div>
</div>
...
<p>Image size:421 X 60</p>
</div>
</div>
<!--alt -->
<div class="form-group">
<div class="col-sm-12">
<input type="text" name="alt_text" value="<?php echo $row['alt_text']; ?>"placeholder="<?php echo translate('alt_text');?>" class="form-control" >
</div>
</div>
<div class="form-group">
<div class="col-sm-12">
<input type="text" name="title" value="<?php echo $row['title']; ?>"placeholder="<?php echo translate('title');?>" class="form-control" >
</div>
</div>
<div class="form-group">
<div class="col-sm-12">
<input id="ban_<?php echo $row['banner_id']; ?>" data-id="<?php echo $row['banner_id']; ?>" class='sw1' type="checkbox" name="status" <?php if($row['status'] == 'ok'){ ?>checked<?php } ?> value="ok" />
</div>
</div>
<div class="form-group">
<div class="col-sm-12">
<input type="text" name="link" value="<?php echo $row['link']; ?>"placeholder="<?php echo translate('link');?>" class="form-control" >
</div>
</div>
</div>
<div class="panel-footer text-right">
<span class="btn btn-info btn-xs btn-labeled fa fa-check submitter" data-ing='<?php echo translate('updating..');?>' data-msg='<?php echo translate('settings_updated!');?>'>
                        ...
                        <div class="col-md-12">
                            ...
                            <?php
                                foreach($home as $row)
                                {
                                    ...
                                    <div class="col-md-<?php echo $l; ?>">
                                        <?php
                                            echo form_open(base_url() . 'index.php/admin/banner/set/'.$row['banner_id'], array('class' => 'form-horizontal','method' => 'post','enctype' => 'multipart/form-data'));
                                                ?>
                                                <div class="panel panel-bordered-grey">
                                                        <div class="panel-body">
                                                            <div class="form-group">
