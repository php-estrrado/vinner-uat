	<div class="panel-body" id="demo_s">
		<table id="demo-table" class="table table-striped"  data-pagination="true" data-show-refresh="true" data-ignorecol="0,4" data-show-toggle="true" data-show-columns="false" data-search="true" >
			...
			<?php
				$i=0;
            	foreach($all_demo_requests as $row){ 
            		$i++;
			?>
                <tr>
                    <td><?php echo $i; ?></td>
                    ...
                    onclick="ajax_modal('view','<?php echo translate('view_demo_request'); ?>','<?php echo translate('successfully_viewed!'); ?>','request_demo_view','<?php echo $row['id']; ?>')" data-original-title="View" data-container="body">
     ...
     <div id="vendr"></div>
    <div id='export-div'>
        <h4 id ='export-title' style="display:none;"><?php echo translate('request_for_demo'); ?></h4>
        <table id="export-table" class="table" data-name='Request For Demo' data-orientation='p' data-width='1500' style="display:none;">
                <colgroup>
                   <col width="50">
					<col width="100">
					<col width="150">
