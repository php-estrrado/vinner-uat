												...
												<div class="row">
													<section class="col-lg-6 col-md-6 col-sm-12 col-12">
														...
														<span id="email_note" style="display: none;"> 
															* <?php echo translate('email_already_registered'); ?>    
														</span>                
													</section>
													...
													<section class="col-lg-6 col-md-6 col-sm-12 col-12">
														<label class="input">
															...
															<input type="text" class="required" name="mobile" value="<?php echo $row['mobile'];?>" placeholder='<?php echo translate('mobile_number'); ?>' data-toggle="tooltip" data-placement="left" title="<?php echo translate('your_mobile_number'); ?>">
														</label>
													</section>
												</div>
...
<style type="text/css">
	...
	#tab-3 .require_alert,#email_note
    {
        color: red;
        position: absolute;
        top: 5px;
	...
	#tab-2 .require_alert,#email_note
	{
		color: red;
		position: absolute;
		top: 5px;
