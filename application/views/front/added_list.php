				...
				if(count($carted) > 0)
			 	{ 	?>
							...
							foreach ($carted as $items)
							{
			                    ...
			                    <div class="ps-product--cart-mobile" data-pid="<?php echo $items['id']; ?>">
			                      ...
			                      <div class="ps-product__content">
			                        ...
			                        <small>
			                        	<?php echo $this->cart->format_number($items['qty']); ?> x <?php echo currency()." ".$this->cart->format_number($items['price']); ?>
			                        </small>
			                      </div>
			                    </div>
			                	<?php
	                ...
	                <div class="ps-cart__footer">
	                    <h3>Sub Total:<strong  class="subtotal-cost scroll_grand" id='scroll_grand'></strong></h3>
	                    <figure>
