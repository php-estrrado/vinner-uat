		<?php
			$welcome_template='';
			$welcome_templateqry= $this->db->get_where('email_template', array('identifier' => 'supplier-approve'));
      ...
      <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto;max-width:684px;width:90%;">
	      ...
	      <tr>
				  <td class="bg_dark email-section" style="text-align:left;">
					  <div class="heading-section heading-section-white" style="background: #fff;padding: 30px;border-right: 1px solid #ddd;border-left:1px solid #ddd;position: relative;">
						
						  <?php 
						  		$welcome_template=str_replace("{name}",ucfirst($uname),$welcome_template);
						  
						  		echo $welcome_template; /*?>
        ...
        <tr>
          <td class="bg_white" style="text-align: center; padding-top: 0x;background: #ddd;padding: 10px 0;">
            <p>
				<a href="<?php echo base_url(); ?>" style="color: rgba(0,0,0,.8);text-decoration: none;font-size:16px;font-family: sans-serif;">
					mydrsasia.com
				</a>
			</p>
          </td>
