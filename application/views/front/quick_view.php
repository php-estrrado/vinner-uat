        ...
        <div class="col-md-7" style="border-right:1px solid #D4D4D4;">
            ...
            <div class="margin-bottom-40">
                ...
                <span class="product-quantity sm-margin-bottom-20">
                    ...
                    <input type='text' readonly class="quantity-field cart_quantity" name='qty' value="<?php if($a = $this->crud_model->is_added_to_cart($row['product_id'],'qty')){echo $a;} else {echo '1';} ?>" id='qty'/>
