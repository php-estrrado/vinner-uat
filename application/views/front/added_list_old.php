    ...
    <ul id="scrollbar" class="list-unstyled badge-open contentHolder">
        ...
        <li>
            ...
            <div class="overflow-h">
                <span style="margin: auto !important;font-size: small !important;" ><?php echo $items['name']; ?></span>
                <small style="font-size: small !important;"><?php echo $this->cart->format_number($items['qty']); ?> x <?php echo currency()." ".$this->cart->format_number($items['price']); ?></small>
                <br>
               <!-- <small><?php //echo translate('tax'); ?>: <?php //echo currency(); ?><?php //echo $tax_n = $this->cart->format_number($items['tax']*$items['qty']); $tax += $tax_n; ?></small>
                ...
                <br>-->
                <small style="font-size: small !important;"><?php echo translate('total'); ?> : <?php echo currency().' '; ?><?php echo $this->cart->format_number($items['subtotal']+$shipping_n+$tax_n); ?></small>
                <?php } else { ?>
                <small style="font-size: small !important;"><?php echo translate('total'); ?> : <?php echo currency().' '; ?><?php echo $this->cart->format_number($items['subtotal']+$tax_n); ?></small>
                <?php } ?>
            </div>
        </li>
        <?php } ?>
