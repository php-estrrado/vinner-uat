<script>
	...
	var product_update = '<?php echo translate('product_quantity_update'); ?>';

	var added_to_cart = '<?php echo translate('added_to_cart'); ?>';

	var quantity_exceeds = '<?php echo translate('out of stock!'); ?>';
	...
	var logup_success = '<?php echo translate('you_are_registered_successfully'); ?>';
