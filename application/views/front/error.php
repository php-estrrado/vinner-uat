                ...
                <div class="error-v4">
                   <a href="<?php echo base_url(); ?>"><img src="<?php echo $this->crud_model->logo('home_top_logo'); ?>" alt=""></a>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-md-offset-3">
                        <p class="list-unstyled link-list" style="margin-top:60px;">2016 &copy; All Rights Reserved @ <a target="_blank" style="color:#000;" href="<?php echo base_url(); ?>">Marinecart</a></p>
                        </div>
                    </div>
                </div>
            </div>
