          ...
          <div class="ps-section__header">
            ...
            <div class="col-md-12">
                ...
                <div class="col-6 col-md-2">
                    <div class="indus_box">
                    <div>
                        <img src="./template/front/assets/img/hore.png">
                    </div>
                    <h4>HoReCa</h4>
                    </div>
                </div>
                <div class="col-6 col-md-2">
                    <div class="indus_box">
                    <div>
                        <img src="./template/front/assets/img/health.png">
                    </div>
                    <h4>Health Care</h4>
                    </div>
                </div>
                <div class="col-6 col-md-2">
                    <div class="indus_box">
                    <div>
                        <img src="./template/front/assets/img/home.png">
                    </div>
                    <h4>Homes</h4>
                    </div>
                </div>
                <div class="col-6 col-md-2">
                    <div class="indus_box">
                    <div>
                        <img src="./template/front/assets/img/educ.png">
                    </div>
                    <h4>Education</h4>
                    </div>
                </div>
                <div class="col-6 col-md-2">
                    <div class="indus_box">
                    <div>
                        <img src="./template/front/assets/img/govern.png">
                    </div>
                    <h4>Government</h4>
                    </div>
                </div>
                <div class="col-6 col-md-2">
                    <div class="indus_box">
                    <div>
                        <img src="./template/front/assets/img/trans.png">
                    </div>
                ...
                <div class="col-6 col-md-2">
                    <div class="indus_box">
                    <div>
                        <img src="./template/front/assets/img/solar.png">
                    </div>
                    <h4>Solar</h4>
                    </div>
                </div>
                <div class="col-6 col-md-2">
                    <div class="indus_box">
                    <div>
                        <img src="./template/front/assets/img/road.png">
                    </div>
                    <h4>Roads & Footpaths</h4>
                    </div>
                </div>
                <div class="col-6 col-md-2">
                    <div class="indus_box">
                    <div>
                        <img src="./template/front/assets/img/fitness.png">
                    </div>
                    <h4>Fitness Club</h4>
                    </div>
                </div>
                <div class="col-6 col-md-2">
                    <div class="indus_box">
                    <div>
                        <img src="./template/front/assets/img/green.png">
                    </div>
                    <h4>Green Houses</h4>
                    </div>
                </div>
