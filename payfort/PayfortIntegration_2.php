...

{
    ...
    public $merchantIdentifier = 'BmGnrDHc';
    ...
    public $projectUrlPath     = '/marine_test/payfort'; 

	

    public function __construct ( $s, $m, $r ,$t,$pr,$si,$amt,$cur,$prdDtl) {
        ...
        $this->itemDetail = $prdDtl;
    }



    public function processRequest($paymentMethod,$price,$currency,$cart_details)
    ...
    { 
        ...
        if ($paymentMethod == 'cc_merchantpage') {
            ...
            $data = $this->getRedirectionData($paymentMethod,$price,$currency,$cart_details);
    ...
    public function getRedirectionData($paymentMethod,$price,$currency,$cart_details) {
        ...
        $decimalPoints = $this->getCurrencyDecimalPoints(strtoupper($currency));
        $postData = array(

         //   'amount'              => $this->convertFortAmount($price,$currency),
            'amount'              => round($price,$decimalPoints),
