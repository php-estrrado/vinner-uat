...

{
 ...
 //   public $gatewaySandboxHost = 'https://checkout.payfort.com/';
    ...
    public $merchantIdentifier = '879b45fb';
    ...
    public $projectUrlPath     = '/vinner/payfort'; 

	

    public function __construct ( $s, $m, $r ,$t,$pr,$si) {
        ...
        $this->merchantReference = $si;

    }



    public function processRequest($paymentMethod,$price,$currency,$sale_id)

    {
        ...
        if ($paymentMethod == 'cc_merchantpage') {
            ...
            $data = $this->getRedirectionData($paymentMethod,$price,$currency,$sale_id);
    ...
    public function getRedirectionData($paymentMethod,$price,$currency,$sale_id) {
        ...
        $postData = array(
            ...
            'amount'              => $this->convertFortAmount($price,$currency),
        ...
        elseif ($paymentMethod == 'VISA_CHECKOUT') {
            $postData['digital_wallet']    = 'VISA_CHECKOUT';
            $postData['command']         = 'PURCHASE';
        }
        elseif ($paymentMethod == 'MASTERPASS') { 
            $postData['digital_wallet']    = 'MASTERPASS';
            $postData['command']         = 'PURCHASE';
         //   $postData['cart_details']    = $this->getProductDetail($sale_id);
	    $postData['cart_details']   =   '{"cart_items":[{"item_name":"Xbox360","item_description":"Xbox","item_quantity":"3","item_price":"300","item_image":"http://image.com"},{"item_name":"Xbox1","item_description":"Xbox","item_quantity":"2","item_price":"500","item_image":"http://image.com"}],"sub_total":"800"}';
        }
    ...
    { 
        $con = mysqli_connect("localhost","marineca_admin","admin@123#","marineca_mcart");
