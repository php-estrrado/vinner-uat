...

{
    ...
    public function processRequest($paymentMethod,$price,$currency)

    {
        ...
        if ($paymentMethod == 'cc_merchantpage') {
            ...
            $data = $this->getRedirectionData($paymentMethod,$price,$currency);
    ...
    public function getRedirectionData($paymentMethod,$price,$currency) {
