    ...
    $('.submitter').on('click', function()
	{
        ...
        if($('#sub_upi').prop('disabled')){ can = 'no'; }
        ...
        if(can !== 'no'){
            ...
            $.ajax({
                ...
                success: function(data) 
				{
                    ...
                    if(data == 'infoup')
					{
						//$("#sky-form1").trigger("reset");
                        notify(msg,'info','bottom','right');
						console.log(base_url);
						window.location = base_url+"home/profile/edit";
                        //location.reload();
                    } 
					else if(data == 'passup')
					{
					...
					else if(data == 'pass_prb') 
					{
                        ...
                        notify("Incorrect current password!",'warning','bottom','right');
                    }
